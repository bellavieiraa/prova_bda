...
where editora = "Secker & Warburg";

#2
update Livros
set disponivel = false
where disponivel = true and ano_publicacao < 1980;
...
select sum(quantidade_paginas), avg (29123)
FROM Livros
...
SELECT titulo 
FROM Livros
WHERE titulo LIKE 'S%' and ano_publicacao > 1975 and ano_publicacao < 1990;
